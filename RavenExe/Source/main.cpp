...
int main(int argc, char** argv) {
    ...
    raven::constructGraph(graph, sequences, thread_pool, checkpoints, kmer_len, window_len, freq);
    raven::assemble(thread_pool, graph, checkpoints);
    raven::polish(thread_pool, graph, checkpoints, sequences, m, n, g, cuda_poa_batches, cuda_banded_alignment, cuda_alignment_batches,
